...
- Completion/cancellation date is read from `COMPLETED:`, `CANCELLED:`, `CANCELLATION:`, or `CANCELATION:` when present.
- If a done task has no explicit completion/cancellation timestamp, `DTSTAMP:` is used.
